...
import { Wallet, Building2, Smartphone, TrendingUp, ChevronRight, Zap } from "lucide-react"
  ...
  return (
    <motion.div
      ...
      className={`cursor-pointer transition-all duration-500 professional-card rounded-2xl p-5 sm:p-6 group touch-manipulation relative overflow-hidden ${
        isSelected ? "ring-4 ring-blue-500/30 shadow-2xl shadow-blue-500/30 bg-gradient-to-r from-blue-50/80 to-indigo-50/80" : ""
      }`}
      onClick={() => {
        onClick(account)
    ...
    >
      ...
      <div className="flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-4 min-w-0 flex-1">
          <div className={`p-3 bg-gradient-to-br ${getCurrencyBg(account.currency)} rounded-2xl group-hover:shadow-lg transition-all duration-300 flex-shrink-0 border border-white/50`}>
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-3 mb-2">
              <div className="text-xl sm:text-2xl font-bold gradient-text group-hover:text-slate-800 transition-colors">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-xs text-slate-500 hidden sm:inline font-medium">Active</span>
          </div>
          <motion.div
            whileHover={{ x: 4 }}
