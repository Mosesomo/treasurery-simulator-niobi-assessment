          ...
          >
            <Card className="professional-card overflow-hidden group relative">
              ...
              <div className="absolute inset-0 opacity-5">
                <div
                  className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${stat.gradient} rounded-full blur-2xl`}
                ></div>
              </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                  <div className="space-y-2 sm:space-y-3 min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <p className="text-sm sm:text-base font-semibold text-slate-600 truncate">
                        {stat.title}
                      </p>
                      <Sparkles className="h-3 w-3 text-slate-400" />
                    </div>
                    <p
                      className={`text-xl sm:text-xl lg:text-xl font-bold ${stat.textColor}`}
                    >
                      {stat.value}
                    </p>
                  </div>
              ...
              ([currency, total], index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`text-center p-4 sm:p-6 bg-gradient-to-br ${bgGradient} rounded-2xl sm:rounded-3xl hover:shadow-2xl transition-all duration-500 border border-white/50 relative overflow-hidden group`}
                  >
                    {/* Background Pattern */}
                    <div className="absolute inset-0 opacity-10">
                      <div
                        className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${gradient} rounded-full blur-2xl`}
                      ></div>
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="text-xl sm:text-xl lg:text-2xl font-bold gradient-text mb-2 sm:mb-3">
